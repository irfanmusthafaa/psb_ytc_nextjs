        ...
        <div className="w-full ">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="mt-5 w-full text-white  bg-[#273b83] hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
              >
