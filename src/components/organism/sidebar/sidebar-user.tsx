      ...
      <div className="w-full px-2">
        <div className="flex flex-col items-center w-full mt-3 border-t border-gray-700">
          ...
          >
            ...
            <span className="ml-2 text-sm font-medium">Detail Biodata</span>
          </a>
          <a
            className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700"
            href="#"
          >
            ...
            <span className="ml-2 text-sm font-medium">Edit Biodata</span>
          </a>
          <a
        ...
        <div className="flex flex-col items-center w-full mt-2 border-t border-gray-700">
          ...
          >
            ...
            <span className="ml-2 text-sm font-medium">Seleksi</span>
          </a>
          <a
            className="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-indigo-700"
            href="#"
