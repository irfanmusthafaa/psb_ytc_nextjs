...
export default function Footer() {
  return (
    <footer id="tentang-kami" className="w-full bg-gray-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6  gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            ...
            >
              <img src="/images/logo.png" alt="logo" width={40} height={8} />
              <p className="text-lg text-gray-800 font-semibold">
                Young Tahfizh Center
              </p>
            </a>
            <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">
              Jl. Sungai Progo No. 239, Semper Bar, Clincing, Jakarta Utara, DKI
              Jakarta
            </p>
            <a
              href="wa.me/628213712032"
          ...
          {/* <!--End Col--> */}
          <div className="lg:mx-auto text-left ">
            <h4 className="text-lg text-gray-900 font-medium mb-7">Info PSB</h4>
            <ul className="text-sm  transition-all duration-500">
              <li className="mb-6">
                <a
                  href="javascript:;"
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="https://pagedone.io/">Copyright</a> 2024, YTC Indonesia.
            </span>
